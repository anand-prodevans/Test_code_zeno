...
public class TestRun {
	...
	@Test(priority = 12, description="Tries to navigate to Day schedule tab (passes)")
	public void dayschedule() throws InterruptedException, IOException {
		lib.waitAndClickForID("dayschedule", "dashboard", "ID");
	}
	
	@Test(priority = 13, description="Tries to pass value to Day schedule tab (passes)")
	...
	@Test(priority = 14, description="Tries to navigate to dates schedule tab (passes)")
	public void dateschedule() throws InterruptedException, IOException {
		lib.waitAndClickForID("dateschedule", "dashboard", "ID");
	}
	

	@Test(priority = 15, description="Tries to pass value to Day schedule tab (passes)")
